...
if __name__ == "__main__":
    ...
    model_parameters_file='./models/configuration/sit_stem_original.json'#sit_linear_patch.json'
    ...
    for data_file in data_files:
        ...
        if False: # for PCA (univariate)
            ...
            data_raw = np.load(uploaded_ts)
            data_raw = (data_raw - scaler_min) / (scaler_max - scaler_min)
            sequence = data_raw
